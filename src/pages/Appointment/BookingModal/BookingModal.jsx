            ...
            <div className="modal modal-bottom sm:modal-middle">
                <div className="modal-box relative">
                    ...
                    <form onSubmit={handleBooking} className='mt-5 grid grid-cols-1 gap-4'>
                        ...
                        <input name='name' defaultValue={'Unknown'} disabled type="text" placeholder="Enter Your Name" className="input input-bordered w-full" />
                        <input name='email' defaultValue={"Unknown"} disabled type="email" placeholder="Enter Your Email" className="input input-bordered w-full" />
